...
class RefundsPageModel {
  const RefundsPageModel({
    required this.items,
  ...
  factory RefundsPageModel.fromJson(Map<String, dynamic> json) {
    final rawItems = json['items'] ?? json['data'] ?? json['refunds'];
